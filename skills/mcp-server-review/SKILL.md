...
description: Review MCP server implementations and configurations for overpermissioning, injection, and data exposure risks.
allowed-tools: Read, Grep, Glob, Bash, WebFetch
---

Source: OWASP Secure Agent Playbook `plugins/ai-security-skills/plays/mcp-server-review.md`.
