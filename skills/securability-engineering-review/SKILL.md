...
description: Run SSEM-scored securability engineering review using the OWASP Secure Agent Playbook FIASSE/SSEM procedure.
allowed-tools: Read, Grep, Glob, Bash, WebFetch
---

Source: OWASP Secure Agent Playbook `plugins/code-security-skills/plays/securability-engineering-review.md`.
