...
description: Audit AI agent implementations for excessive permissions, prompt-injection surfaces, data-exfiltration paths, and unsafe tool usage.
allowed-tools: Read, Grep, Glob, Bash, WebFetch
---

Source: OWASP Secure Agent Playbook `plugins/ai-security-skills/plays/agent-security-audit.md`.
...
## Shared finding/report format

Use the `owasp-security-reporting-template` skill's finding and report format when producing audit output.
