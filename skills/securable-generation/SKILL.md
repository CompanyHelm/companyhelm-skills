---
name: securable-generation
description: Run the OWASP Secure Agent Playbook securable generation full-loop play.
allowed-tools: Read, Grep, Glob, Bash, WebFetch
---

Source: OWASP Secure Agent Playbook `plugins/code-security-skills/plays/securable-generation.md`.
