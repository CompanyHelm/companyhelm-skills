---
name: prd-fiasse-asvs-enhancement
description: Run the PRD FIASSE / ASVS enhancement runbook from the OWASP Secure Agent Playbook.
allowed-tools: Read, Grep, Glob, Bash, WebFetch
---

Source: OWASP Secure Agent Playbook `plugins/code-security-skills/plays/prd-fiasse-asvs-enhancement.md`.
