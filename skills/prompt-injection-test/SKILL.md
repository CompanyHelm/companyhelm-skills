...
description: Run structured prompt-injection testing for LLM-integrated applications and agents.
allowed-tools: Read, Grep, Glob, Bash, WebFetch
---

Source: OWASP Secure Agent Playbook `plugins/ai-security-skills/plays/prompt-injection-testing.md`.
