...
description: Assess REST, GraphQL, gRPC, OpenAPI, and API gateway surfaces against OWASP API Security Top 10 2023.
allowed-tools: Read, Grep, Glob, Bash, WebFetch
---

Source: OWASP Secure Agent Playbook `plugins/code-security-skills/plays/api-security-review.md`.
