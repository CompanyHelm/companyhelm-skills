...
description: Review web applications against the OWASP Top 10 Web Application risks.
allowed-tools: Read, Grep, Glob, Bash, WebFetch
---

Source: OWASP Secure Agent Playbook `plugins/code-security-skills/plays/owasp-top10-web-review.md`.
