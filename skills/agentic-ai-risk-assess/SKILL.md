...
description: Assess agentic AI applications against the OWASP Top 10 for Agentic Applications 2026.
allowed-tools: Read, Grep, Glob, Bash, WebFetch
---

Source: OWASP Secure Agent Playbook `plugins/ai-security-skills/plays/agentic-ai-risk-assess.md`.
