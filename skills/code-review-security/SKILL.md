...
description: Perform evidence-backed secure code review mapped to OWASP, CWE, ASVS, and OpenCRE.
allowed-tools: Read, Grep, Glob, Bash, WebFetch
---

Source: OWASP Secure Agent Playbook `plugins/code-security-skills/plays/code-review-security.md`.
