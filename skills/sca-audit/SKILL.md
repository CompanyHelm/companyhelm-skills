---
name: sca-audit
description: Audit project dependencies for known vulnerabilities and supply-chain risks.
allowed-tools: Read, Grep, Glob, Bash, WebFetch
---

Source: OWASP Secure Agent Playbook `plugins/code-security-skills/plays/sca-audit.md`.
