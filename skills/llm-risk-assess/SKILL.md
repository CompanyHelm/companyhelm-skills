...
description: Assess LLM-powered applications against OWASP Top 10 for LLM Applications 2025.
allowed-tools: Read, Grep, Glob, Bash, WebFetch
---

Source: OWASP Secure Agent Playbook `plugins/ai-security-skills/plays/llm-risk-assess.md`.
