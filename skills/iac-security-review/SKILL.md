...
description: Review Terraform, Kubernetes, CloudFormation, and other Infrastructure-as-Code for security risks.
allowed-tools: Read, Grep, Glob, Bash, WebFetch
---

Source: OWASP Secure Agent Playbook `plugins/code-security-skills/plays/iac-security-review.md`.
