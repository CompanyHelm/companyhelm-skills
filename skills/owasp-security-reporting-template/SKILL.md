---
name: owasp-security-reporting-template
description: Shared OWASP Secure Agent Playbook templates for evidence-backed security findings and assessment reports.
allowed-tools: Read, Grep, Glob, Bash, WebFetch
---

# OWASP Security Reporting Template

Source: OWASP Secure Agent Playbook templates.
