---
name: secrets-scan
description: Detect hardcoded credentials, API keys, tokens, and private key material.
allowed-tools: Read, Grep, Glob, Bash, WebFetch
---

Source: OWASP Secure Agent Playbook `plugins/code-security-skills/plays/secrets-scan.md`.
